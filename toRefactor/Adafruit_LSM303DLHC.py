...
class LSM303DLHC:
    ...
    # LSM303DLHC Registers								Default		Type
    __LSM303DLHC_REGISTER_MAG_TEMP_OUT_L_M = 0x05
    __LSM303DLHC_REGISTER_MAG_TEMP_OUT_H_M = 0x06
    __LSM303DLHC_REGISTER_STATUS_M = 0x07
    __LSM303DLHC_REGISTER_MAG_OUT_X_L_M = 0x08
    __LSM303DLHC_REGISTER_MAG_OUT_X_H_M = 0x09
    __LSM303DLHC_REGISTER_MAG_OUT_Y_L_M = 0x0A
    __LSM303DLHC_REGISTER_MAG_OUT_Y_H_M = 0x0B
    __LSM303DLHC_REGISTER_MAG_OUT_Z_L_M = 0x0C
    __LSM303DLHC_REGISTER_MAG_OUT_Z_H_M = 0x0D
    # __LSM303DLHC_REGISTER_WHO_AM_I = 0x0F
    # __LSM303DLHC_REGISTER_INT_CTRL_M = 0x12
    # __LSM303DLHC_REGISTER_INT_SRC_M = 0x13
    # __LSM303DLHC_REGISTER_INT_THS_L_M = 0x14
    # __LSM303DLHC_REGISTER_INT_THS_H_M = 0x15



    __LSM303DLHC_REGISTER_ACCEL_CTRL_REG0_A = 0x1F  # 00000111   rw
